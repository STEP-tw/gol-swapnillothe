...
describe("getNthGeneration",function() {
  ...
  it("should work for one next generation",function() {
    let currentGeneration = [[1,1],[1,2],[1,3]];
    deepEqual( getNthGeneration( currentGeneration, bounds, 1 ),[[1,2],[2,2]]);
  });
  it("should work for more than one next generation",function() {
    let currentGeneration = [[1,1],[1,2],[1,3],[3,2]];
    deepEqual( getNthGeneration( currentGeneration, bounds, 2 ),[[1,2],[2,2]]);
  });
});
